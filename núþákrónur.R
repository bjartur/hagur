...
# lista: (listi yfir datatframe) annadhvort breytan aldursflokkar eda byggdir # lysistaerd: (strengur) nafndi a breytistaerdinni innan dataframe sem a ad saekja # skilar: lista af listum, stadlad
