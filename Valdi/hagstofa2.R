...
#
dalknofn <- c("Ar", "Eigniralls", "Medaltaleigna", "Midgildieigna", "Fasteignir", "Okutaeki", "Innlan", "Verdbrjef", "Adrareignir", "Skuldiralls", "Medaltalskulda", "Midgildiskulda", "Ibudarlan", "Adrarskuldir", "EigidFje", "Egidfjeifasteign", "Eigidfjeannad", "Fjoldiihop", "Medaltalskuldaskuldsettra", "Fjoldiskuldsettra")

#breytilegt eftir aðstæðum
folderpath <- "SkuldirEignirOgEiginfjarstadaEftirFjolskyldugerdAldriOgBusetu/"

filename <- "eignirOgSkuldir"
