...
#	15	FjoldiIHop
#
dalknofn <- c("Artal", "Heildartekjur", "Medaltekjur", "MidgildiTekna", "Atvinnutekjur", "Fjarmagnstekjur", "AdrarTekjur", "Skattar", "VaxtaOgBarnabaetur", "Heildarskattar(SkattarVaxtaOgBarnabaetur)", "VaxtagjoldV/Ibudalana", "OnnurVaxtagjold", "Radstofunartekjur(Heildartekjur-Heildarskattar)", "Radstofunartekjur2", "FjoldiIHop")

#breytilegt eftir aÃ°stÃ¦Ã°um
folderpath <- "C:/Users/EggertŞór/Documents/Skólinn/Reiknigreind/Project 1/TekjurOgGjöldEinstaklingaEftirFjölskyldugerğ,AldriOgBúsetu1997-2013/Gognin/"
