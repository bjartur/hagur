...
source("Valdi/Radstofunartekjur.R", encoding="UTF-8")
...
# Fyrir: 
	#	valtiundir eru valdar tíundir. T.d. c(i:j) fyrir tíundir i til j, 1 <= i <= j <= 10
...
# Notkun: medalT = medalTek(tafla, dalkurmedal, fjoldiihop, fjoldihopa,)
# Fyrir: 
